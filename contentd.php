...
//============================================================================================================================= proses fuzzifikasi
	...
	$hasil_variabel1	=mysql_query($sql_variabel1);
	$row_variabel1	=mysql_fetch_assoc($hasil_variabel1);
...
<table border="1" cellpadding="3" width="95%">
 ...
 <?php
			...
			while($row1=mysql_fetch_assoc($hasil1))
				{
		?>	
	...
	<tr>
      ...
      <?php
        ...
        <?php
			...
			while($row21=mysql_fetch_assoc($hasil21))
				{
		?>	
        <td >
		<?php 
        ...
        <?php
			...
			while($rowd=mysql_fetch_array($hasild))
				{
		$nx=$rowd[f];
		$hx=$rowd[idhimpunan];
		...
		echo "<td>$rowd[f]</td>"; 
			...
			$hasild1	=mysql_query($sqld1);
			while($rowd1=mysql_fetch_array($hasild1))
				{
		$ny=$rowd1[f];
		$hy=$rowd1[idhimpunan];
